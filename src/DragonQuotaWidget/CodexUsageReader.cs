...
public enum UsageSurface { Codex, Work }
...
public sealed record UsageBySurface(UsageTotals Codex, UsageTotals Work)
{
    public static UsageBySurface Empty { get; } = new(UsageTotals.Empty, UsageTotals.Empty);
    public UsageTotals Total => Codex + Work;
}
